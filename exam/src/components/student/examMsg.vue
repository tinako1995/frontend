  ...
  <div id="msg">
    ...
    <div class="wrapper">
      ...
      <ul class="bottom">
        ...
        <li class="right"><el-button @click="toAnswer(examData.examCode)">開始答題</el-button></li>
      </ul>
      <ul class="info">
        ...
        <el-collapse-item class="header" name="0">
          <template slot="title" class="stitle" >
            <div class="title">
              ...
              <span class="time">{{examData.totalScore}}分 / {{examData.totalTime}}分鐘</span>
              <el-button type="primary" size="small">點擊看更多</el-button>
            </div>
          </template>
          <el-collapse class="inner">
            <el-collapse-item>
              <template slot="title" name="1">
                <div class="titlei">選擇題 (共{{topicCount[0]}}題 共計{{score[0]}}分)</div>
              </template>
              <div class="contenti">
            ...
            <el-collapse-item>
              <template slot="title" name="2">
                <div class="titlei">填空題 (共{{topicCount[1]}}題  共計{{score[1]}}分)</div>
              </template>
              <div class="contenti">
            ...
            <el-collapse-item>
              <template slot="title" name="3">
                <div class="titlei">是非題 (共{{topicCount[2]}}題 共計{{score[2]}}分)</div>
              </template>
              <div class="contenti">
