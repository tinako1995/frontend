    ...
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          ...
          <li><a href="javascript:;" @click="exam()">開始考試</a></li>
          <li><a href="javascript:;" @click="practice()">我的練習</a></li>
          <li><router-link to="/scoreTable">我的分數</router-link></li>
          <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag">
            <a href="javascript:;"><i class="iconfont icon-Userselect icon"></i>{{user.userName}}</a>
            <div class="msg" v-if="flag">
              <p @click="manage()">會員中心</p>
              <p class="exit" @click="exit()">登出</p>
            </div>
          </li>
        </ul>
      </el-col>
